...
public class Zipper{
	...
	*/
	...
	public static String zip2(String s1, String s2) throws Exception{
		if(s1 == null || s2 == null) throw new TooFewArgumentsException("error: must pass two command line arguments");
		if(s1.length() != s2.length())
			throw new ArgumentLengthsDifferException("error: length of command line arguments differs (" + s1.length()
				+ ", " + s2.length() + ")");
